...
function setupMobileControls() {
    ...
    Object.entries(buttons).forEach(([direction, button]) => {
        button.addEventListener('touchstart', (e) => handleTouchStart(direction, e));
        button.addEventListener('touchend', (e) => handleTouchEnd(direction, e));
        button.addEventListener('touchcancel', (e) => handleTouchEnd(direction, e));
